...
class PosController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $products = $products->where('digital',0); // Added by Pranay Rudra
        ...
        $stocks = new PosProductCollection($products->paginate(20));
    ...
    public function order_store(Request $request){
        ...
        if(Session::has('pos.cart') && count(Session::get('pos.cart')) > 0){
            ...
            $order->delivery_status = ($order->payment_status == "paid")?"delivered":"pending"; // Added by Pranay Rudra
            $order->shipping_type = ($order->payment_status == "paid")?"pickup_point":""; // Added by Pranay Rudra
            ...
            if($order->save()){
                ...
                if(env('MAIL_USERNAME') != null){
                    try {
                        ...
                        Mail::to(User::where('user_type', 'staff')->first()->email)->queue(new InvoiceEmailManager($array));
                    } catch (\Exception $e) {
