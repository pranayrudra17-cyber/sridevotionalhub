...
class SearchController extends Controller
{
    public function index(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        // Pranay Rudra
        $conditions = array_merge($conditions, ['digital' => 0]);
        ...
        switch ($sort_by) {
            ...
            case 'price-desc':
                ...
                break;
            default:
                $products->inRandomOrder(); //$products->orderBy('id', 'desc');
                break;
        }
    ...
    public function ajax_search(Request $request)
    {
        ...
        $products = Product::where('published', 1)->where('digital', 0)->where('tags', 'like', '%' . $query . '%')->get();
        ...
        $products = $products->where('published', 1)->where('digital', 0)
        ...
        $categories = Category::where('name', 'like', '%' . $query . '%')->where('digital', 0)->get()->take(3);
