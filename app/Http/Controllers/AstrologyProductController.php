...
class AstrologyProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($product->save()) {
            ...
            flash(translate('Astrology Service has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($product->save()) {
            ...
            flash(translate('Astrology Service has been updated successfully'))->success();
            return back();
        } else {
            flash(translate('Something went wrong'))->error();
            return back();
