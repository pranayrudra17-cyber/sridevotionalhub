...
Route::controller(HomeController::class)->group(function () {
    ...
    // Pranay
    Route::get('/astrology', 'astrology')->name('astrologies.all');
    Route::get('/astrology/{slug}', 'astrology_slug')->name('astrology');
    Route::get('/pooja', 'pooja')->name('pooja.all');
    Route::get('/pooja/{slug}', 'pooja_slug')->name('pooja');
    Route::get('/pandit', 'pooja')->name('pooja.all');
    Route::get('/pandit/{slug}', 'pooja_slug')->name('pooja');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function() {
    ...
    Route::controller(PurchaseHistoryController::class)->group(function () {
        ...
        Route::get('astrology_purchase_history', 'astrology_index')->name('astrology_purchase_history.index');
        Route::get('pooja_purchase_history', 'pooja_index')->name('pooja_purchase_history.index');
    });
...
Route::group(['prefix' => 'shipment'], function () {
    Route::controller(ShiprocketController::class)->group(function () {
        Route::post('/pincode', 'pincode')->name('shipment.pincode');
        Route::get('/orders', 'orders')->name('shipment.all');
        Route::get('/order-details/{order_id}', 'order_details')->name('shipment.order');
        Route::get('/track/{order_id}', 'track')->name('shipment.track');
        Route::get('/tracking-details/{awb}', 'tracking_details')->name('shipment.tracking_details');
        Route::get('/balance', 'get_balance')->name('shipment.balance');
...
Route::controller(PageController::class)->group(function () {
    ...
    Route::get('/mobile-shipment-tacking-page/{order_id}', 'mobile_shipment_tacking_page')->name('mobile.shipment-tacking-page');
