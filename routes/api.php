...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::get('products/astrology', 'App\Http\Controllers\Api\V2\ProductController@astrology');
    Route::get('products/pooja', 'App\Http\Controllers\Api\V2\ProductController@pooja');
    Route::get('products/pandit', 'App\Http\Controllers\Api\V2\ProductController@pooja');
    Route::get('products/featured', 'App\Http\Controllers\Api\V2\ProductController@featured');
    Route::get('products/newly', 'App\Http\Controllers\Api\V2\ProductController@newly');
    ...
    Route::get('products/astrology-related/{id}', 'App\Http\Controllers\Api\V2\ProductController@astrologyRelated')->name('products.astrologyRelated');
    Route::get('products/pooja-related/{id}', 'App\Http\Controllers\Api\V2\ProductController@poojaRelated')->name('products.poojaRelated');
    ...
    Route::get('products/poojarilang', 'App\Http\Controllers\Api\V2\ProductController@poojariLang');
    ...
    Route::prefix('shipment')->group(function () {
        Route::post('pincode', 'App\Http\Controllers\Api\V2\ShiprocketController@pincode');
        Route::get('orders', 'App\Http\Controllers\Api\V2\ShiprocketController@orders');
        Route::get('order-details/{order_id}', 'App\Http\Controllers\Api\V2\ShiprocketController@order_details');
        Route::get('track/{order_id}', 'App\Http\Controllers\Api\V2\ShiprocketController@track');
        Route::get('tracking-details/{awb}', 'App\Http\Controllers\Api\V2\ShiprocketController@tracking_details');
        Route::get('balance', 'App\Http\Controllers\Api\V2\ShiprocketController@get_balance');
        // Route::get('cancel-order/{order_id}', 'App\Http\Controllers\Api\V2\ShiprocketController@pcancel_order');
    });
});
