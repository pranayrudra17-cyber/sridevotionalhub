...
use App\Http\Controllers\PoojaProductController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // Pranay
    Route::resource('poojaproducts', PoojaProductController::class);
    Route::controller(PoojaProductController::class)->group(function () {
        Route::get('/poojaproducts/edit/{id}', 'edit')->name('poojaproducts.edit');
        Route::get('/poojaproducts/destroy/{id}', 'destroy')->name('poojaproducts.destroy');
        Route::get('/poojaproducts/download/{id}', 'download')->name('poojaproducts.download');

        Route::post('/poojaproducts/sku_combination', 'sku_combination')->name('poojaproducts.sku_combination');
        Route::post('/poojaproducts/sku_combination_edit', 'sku_combination_edit')->name('poojaproducts.sku_combination_edit');
        Route::post('/poojaproducts/add-more-choice-option', 'add_more_choice_option')->name('poojaproducts.add-more-choice-option');
        Route::post('/poojaproducts/{poojaproduct}', 'update')->name('poojaproducts.update');
    });
    // end
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        //Update product stocks (added by pranay rudra)
        Route::post('/product-stock-upload', 'stock_upload')->name('product_stock_upload');
    });
