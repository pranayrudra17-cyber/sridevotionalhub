        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <h1 class="fw-600 h4">{{ translate('All Products') }}</h1>
                </div>
                <div class="col-lg-6">
            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                        ...
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                ...
                                <div class="bg-white shadow-sm rounded mb-3">
                                    ...
                                    <div class="p-3">
                                        <ul class="list-unstyled">
                                            @if (!isset($category_id))
                                                @foreach (\App\Models\Category::where('level', 0)->where('digital', 0)->get() as $category)
                                                    <li class="mb-2 ml-2">
                                ...
                                @foreach ($attributes as $attribute)
                                    @if($attribute->id != 3 && $attribute->id != 10 && $attribute->id != 11) {{-- Added by Pranay --}}
                                    <div class="bg-white shadow-sm rounded mb-3">
                                        <div class="fs-15 fw-600 p-3 border-bottom">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row gutters-4 row-cols-xxl-5 row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-2">
