...
<head>
    ...
    @if(!isset($detailedProduct) && !isset($customer_product) && !isset($shop) && !isset($page) && !isset($blog))
        ...
        <meta name="twitter:site" content="{{ '@'.str_replace(' ','_',get_setting('meta_title')) }}">
...
<body>
    ...
    <script>
        ...
        var userType = '{{ (Auth::check())?Auth::user()->user_type:null }}';
    ...
    <script>
        ...
        function checkAddToCartValidity(){
            ...
            if($('#option-choice-form input:radio:checked').length == count){
                if($("#pooja_attribute_id").length > 0)
                {
                    $("#pooja_attribute_id").attr('name',$('#option-choice-form input:radio:checked').attr('name'));
                    $("#pooja_attribute_id").attr('value',$('#option-choice-form input:radio:checked').val());
                }
                return true;
            }
        ...
        window.addEventListener('load', function(){
            $(function() {
                ...
                "chatButtonSetting":{
                    ...
                    "ctaText":"{{ translate('Chat with us') }}",
                    "borderRadius":"25",
                    "marginLeft":"16",
                    "marginBottom":"60",
                    "marginRight":"5",
                ...
                "brandSetting":{
                    ...
                    "brandSubTitle":"",
                    "brandImg":"{{ uploaded_asset(get_setting('site_icon')) }}",
                    "welcomeText":"Hi there!\nHow can I help you?",
                    "messageText":"Hello {{ env('APP_NAME') }}..!",
                    "backgroundColor":"#0a5f54",
                    "ctaText":"Send",
                    "borderRadius":"25",
                    "autoShow":false,
                    "phoneNumber":"{{ explode(',',get_setting('contact_phone'))[0] }}"
                }
                };
                s.onload = function() {
