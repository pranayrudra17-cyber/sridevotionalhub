...
@section('meta')
    ...
    <meta property="og:url" content="{{ route('pooja', $detailedProduct->slug) }}" />
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-left">
                    <ul class="breadcrumb bg-transparent p-0">
                        ...
                        <li class="breadcrumb-item opacity-50">
                            <a class="text-reset" href="{{ route('pooja.all') }}">{{ translate('Pooja')}}</a>
                        </li>
                ...
                <div class="col-lg-6">
                    <ul class="breadcrumb-book bg-transparent p-0 m-0 justify-content-lg-end">
                        @php $previous = get_pooja_previous_product($detailedProduct->id); $previousProduct = (get_single_product([$previous])); @endphp
                        <li class="text-dark prev-book-navigation fw-600 breadcrumb-item">
                            <a class="text-reset {{ (!$previous)?'opacity-50':''}}" href="{{ ($previous)?route('pooja', $previousProduct->first()->slug):'javascript:void(0);'}}">
                            ...
                            @if($previous)
                                <div class="product-nav-item-content">
                                    <a class="product-nav-item-link" href="{{ route('pooja', $previousProduct->first()->slug) }}"></a>
                        ...
                        @php $next = get_pooja_next_product($detailedProduct->id); $nextProduct = (get_single_product([$next])); @endphp
                        <li class="text-dark next-book-navigation fw-600 breadcrumb-item">
                            <a class="text-reset {{ (!$next)?'opacity-50':''}}" href="{{ ($next)?route('pooja', $nextProduct->first()->slug):'javascript:void(0);'}}">
                                {{ translate('NEXT_CAP') }}
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="14" viewBox="0 0 17 17">
                                    <g>
                                    </g>
                            ...
                            @if($next)
                                <div class="product-nav-item-content">
                                    <a class="product-nav-item-link" href="{{ route('pooja', $nextProduct->first()->slug) }}"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="#" class="text-reset">{{ translate('Half hourly flat rates applied for all the pooja consultations') }}</a>
                                </div>
                            ...
                            <form id="option-choice-form">
                                ...
                                @if ($detailedProduct->choice_options != null)
                                            ...
                                            <div class="col-sm-10">
                                                <div class="aiz-radio-inline">
                                                    @foreach ($choice->values as $key => $value)
                                                        @php
                                                            $stock = $detailedProduct->stocks->where('variant', $value)->first();
                                                        @endphp
                                                        <label class="aiz-megabox pl-0 mr-2">
                                                            ...
                                                            <span
                                                                class="aiz-megabox-elem rounded d-flex align-items-center justify-content-center py-2 px-3 mb-2" @if(($stock != null) && ($stock->description != '')) data-toggle="tooltip" data-placement="right" title="{{ $stock->description }}" data-html="true" @endif >
                                                                {{ $value }}
                                                            </span>
                                                        </label>
                                                    @endforeach
                                    ...
                                    @endforeach
                                    <input type="hidden" name="quantity" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="10" lang="en">
                                @endif
                ...
                <div class="col-xl-3">
                    ...
                    <div class="bg-white rounded shadow-sm mb-3">
                        <div class="p-3 border-bottom fs-16 fw-600">
                            {{ translate('Top Booked')}}
                        </div>
                        <div class="p-3">
                            <ul class="list-group list-group-flush">
                                @foreach (filter_products(\App\Models\Product::where('user_id', $detailedProduct->user_id)->where('digital', 2)->orderBy('num_of_sale', 'desc'))->limit(6)->get() as $key => $top_product)
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        <div class="col-5">
                                            <a href="{{ route('pooja', $top_product->slug) }}" class="d-block text-reset">
                                                <img
                                        ...
                                        <div class="col-7">
                                            <h4 class="fs-13 text-truncate-2">
                                                <a href="{{ route('pooja', $top_product->slug) }}" class="d-block text-reset">{{ $top_product->getTranslation('name') }}</a>
                                            </h4>
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="6" data-lg-items="5"  data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                @foreach (filter_products(\App\Models\Product::where('category_id', $detailedProduct->category_id)->where('id', '!=', $detailedProduct->id)->where('digital', 2))->limit(10)->get() as $key => $related_product)
                                <div class="carousel-box">
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        <div class="">
                                            <a href="{{ route('pooja', $related_product->slug) }}" class="d-block">
                                                <img
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            ...
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                                <a href="{{ route('pooja', $related_product->slug) }}" class="d-block text-reset">{{ $related_product->getTranslation('name') }}</a>
                                            </h3>
...
@section('modal')
            ...
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required placeholder="{{ translate('Your Question') }}">{{ route('pooja', $detailedProduct->slug) }}</textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="book_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal modal-md" id="modal-size" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title fw-600 heading-5">{{ translate('Pooja') }} - {{ translate($detailedProduct->getTranslation('name')) }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form class="" onsubmit="return bookNow();" id="book-now-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $detailedProduct->id }}">
                    <input type="hidden" id="pooja_attribute_id" name="attribute_id" value="" >
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <input class="form-control w-100 input" name="name" id="name" required placeholder="{{ translate('Your Name') }}" type="text" value="{{ Auth::check()?Auth::user()->name:'' }}" >
                            </div>
                            <div class="col-12 mb-2">
                                <label for="email">Email*</label>
                                <input class="form-control w-100 input" name="email" id="email" required placeholder="{{ translate('Your Email') }}" type="email" value="{{ Auth::check()?Auth::user()->email:'' }}" >
                            </div>
                            <div class="col-12 mb-2">
                                <label for="mobile">Mobile Number*</label>
                                <input type="text" name="mobile" id="mobile" required placeholder="{{ translate('Your Mobile Number') }}" maxlength="10" onkeyup="this.value=this.value.replace(/[^\d]/,'')" class="form-control w-100 input" value="{{ Auth::check()?Auth::user()->phone:'' }}" >
                            </div>
                            <div class="col-12">
                                <label for="subject">Subject*</label>
                                <textarea class="form-control" rows="8" name="subject" id="subject" required placeholder="{{ translate('Your Subject') }}"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
