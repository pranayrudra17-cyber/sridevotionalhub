        ...
        <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-left">
                <ul class="breadcrumb bg-transparent p-0">
                    ...
                    <li class="breadcrumb-item opacity-50">
                        <a class="text-reset" href="{{ route('search') }}">{{ translate('Store')}}</a>
                    </li>
            ...
            <div class="col-lg-6">
                <ul class="breadcrumb-book bg-transparent p-0 m-0 justify-content-lg-end">
                    @php $previous = get_store_previous_product($detailedProduct->id); $previousProduct = (get_single_product([$previous])); @endphp
                    <li class="text-dark prev-book-navigation fw-600 breadcrumb-item">
                        <a class="text-reset {{ (!$previous)?'opacity-50':''}}" href="{{ ($previous)?route('product', $previousProduct->first()->slug):'javascript:void(0);'}}">
                        ...
                        @if($previous)
                            <div class="product-nav-item-content">
                                <a class="product-nav-item-link" href="{{ route('product', $previousProduct->first()->slug) }}"></a>
                    ...
                    @php $next = get_store_next_product($detailedProduct->id); $nextProduct = (get_single_product([$next])); @endphp
                    <li class="text-dark next-book-navigation fw-600 breadcrumb-item">
                        <a class="text-reset {{ (!$next)?'opacity-50':''}}" href="{{ ($next)?route('product', $nextProduct->first()->slug):'javascript:void(0);'}}">
                            {{ translate('NEXT_CAP') }}
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="14" viewBox="0 0 17 17">
                                <g>
                                </g>
                        ...
                        @if($next)
                            <div class="product-nav-item-content">
                                <a class="product-nav-item-link" href="{{ route('product', $nextProduct->first()->slug) }}"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <hr>
                            @if ((get_setting('conversation_system') == 1) || ($detailedProduct->brand != null))
                            <div class="row align-items-center">
                                        ...
                                        <div class="product-quantity d-flex align-items-center">
                                            ...
                                            <div class="avialable-amount opacity-60">
                                                @if ($detailedProduct->stock_visibility_state == 'quantity')
                                                    @if($qty <= 10)
                                                        ({{ translate('Hurry! A few stock left') }})
                                                    @else
                            ...
                            @if(get_setting('delivery_options') == 1)
                                <!-- Delivery Options -->
                                @include('frontend.delivery_options')
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="p-3">
                            <ul class="list-group list-group-flush">
                                @foreach (filter_products(\App\Models\Product::where('user_id', $detailedProduct->user_id)->where('digital', 0)->orderBy('num_of_sale', 'desc'))->limit(6)->get()
        as $key => $top_product)
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="5"
                                ...
                                @foreach (filter_products(\App\Models\Product::where('category_id', $detailedProduct->category_id)->where('id', '!=', $detailedProduct->id)->where('digital', 0))->limit(10)->get()
