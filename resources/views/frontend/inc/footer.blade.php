        ...
        <div class="row no-gutters text-center">
            <div class="col-3 col-md-6 col-lg-3">
                <a class="text-reset border-left text-center p-4 d-block" href="{{ route('terms') }}">
                    ...
                    <h4 class="h6 d-none d-md-block">Terms & Conditions</h4>
                </a>
            </div>
            <div class="col-3 col-md-6 col-lg-3">
                <a class="text-reset border-left text-center p-4 d-block" href="{{ route('returnpolicy') }}">
                    <i class="la la-mail-reply la-3x text-primary mb-2"></i>
                    <h4 class="h6 d-none d-md-block">Cancellation & Return Policy</h4>
                </a>
            </div>
            <div class="col-3 col-md-6 col-lg-3">
                <a class="text-reset border-left text-center p-4 d-block" href="{{ route('shippingpolicy') }}">
                    <i class="la la-truck la-3x text-primary mb-2"></i>
                    <h4 class="h6 d-none d-md-block">Shipping Policy</h4>
                </a>
            </div>
            <div class="col-3 col-md-6 col-lg-3">
                <a class="text-reset border-left border-right text-center p-4 d-block" href="{{ route('privacypolicy') }}">
                    <i class="las la-exclamation-circle la-3x text-primary mb-2"></i>
                    <h4 class="h6 d-none d-md-block">Privacy Policy</h4>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div class="d-inline-block d-md-block mb-4 d-flex col-12">
                        <form class="form-inline d-flex" method="POST" action="{{ route('subscribers.store') }}">
                            @csrf
                            <div class="form-group mb-0 col-8 p-0">
                                <input type="email" class="form-control w-100" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
                            <div class="col-4 p-0">
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           <span class="d-block opacity-30">{{ translate('Managing Director') }}:</span>
                           <span class="d-block opacity-70">{{ translate('Sandeep Kumar Jilla') }}</span>
                        </li>
                        <li class="mb-2">
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('support_ticket.index') }}">
                    ...
                    <ul class="list-inline my-3 my-md-0 social colored d-none d-md-block">
...
<!-- FOOTER -->
<footer class="pt-2 pb-2 pb-xl-2 bg-black text-light">
    <div class="container">
