            ...
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @else
                    ...
                    @if(Auth::user()->user_type == 'customer')
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('astrology_purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['astrology_purchase_history.index'])}}">
                                <i class="las la-asterisk aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Astrologies') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('pooja_purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pooja_purchase_history.index'])}}">
                                <i class="las la-users aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Pooja`s') }}</span>
                            </a>
                        </li>
                    @endif
