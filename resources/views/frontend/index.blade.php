...
@section('content')
        ...
        @if (count($newest_products) > 0)
            <section class="mb-4">
                <div class="container position-relative">
                    <!--<div class="bg-logo-lb"></div>
                    <div class="bg-logo-rt"></div>-->
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
    ...
    <div id="section_astrology">
        @if (count($astrology_products) > 0)
            <section class="mb-4">
                <div class="container position-relative">
                    <!--<div class="bg-logo-lb"></div>
                    <div class="bg-logo-rt"></div>-->
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">
                                    {{ translate('Astrology Services') }}
                                </span>
                            </h3>
                        </div>
                        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="7" data-lg-items="5"  data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows='true'>
                            @foreach ($astrology_products as $key => $astrology_product)
                            <div class="carousel-box">
                                @include('frontend.partials.astrology_box',['product' => $astrology_product])
                            </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <div id="section_pooja">
        @if (count($pooja_products) > 0)
            <section class="mb-4">
                <div class="container position-relative">
                    <!--<div class="bg-logo-lb"></div>
                    <div class="bg-logo-rt"></div>-->
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">
                                    {{ translate('Pooja Services') }}
                                </span>
                            </h3>
                        </div>
                        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="7" data-lg-items="5"  data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows='true'>
                            @foreach ($pooja_products as $key => $pooja_product)
                            <div class="carousel-box">
                                @include('frontend.partials.pooja_box',['product' => $pooja_product])
                            </div>
                            @endforeach
                        </div>
                    </div>
