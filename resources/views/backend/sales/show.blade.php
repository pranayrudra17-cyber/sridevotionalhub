                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                            <a href="{{ route((($orderDetail->product->digital == 1)?'astrology':(($orderDetail->product->digital == 2)?'pooja':'product')), $orderDetail->product->slug) }}" target="_blank">
                                    ...
                                    <td>
                                        @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                            ...
                                            <small>
                                                ...
                                                @php
                                                    $product_stock = json_decode((($orderDetail->product->stocks)->where('variant',$orderDetail->variation))->first(), true);
                                                @endphp
