                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                      <a href="{{ route((($orderDetail->product->digital == 1)?'astrology':(($orderDetail->product->digital == 2)?'pooja':'product')), $orderDetail->product->slug) }}" target="_blank"><img height="50px" src="{{ uploaded_asset($orderDetail->product->thumbnail_img) }}"></a>
                                ...
                                <td>
                                    @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                      <strong><a href="{{ route((($orderDetail->product->digital == 1)?'astrology':(($orderDetail->product->digital == 2)?'pooja':'product')), $orderDetail->product->slug) }}" target="_blank" class="text-muted">{{ $orderDetail->product->getTranslation('name') }}</a></strong>
