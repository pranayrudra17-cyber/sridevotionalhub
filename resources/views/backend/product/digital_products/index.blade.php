            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td class="text-left">
                            <a class="btn btn-soft-success btn-icon btn-circle btn-sm"  href="{{ route('astrology', $product->slug) }}" target="_blank" title="{{ translate('View') }}">
                                <i class="las la-eye"></i>
                            </a>
                            @can('edit_digital_product')
