        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="type" id="type" onchange="sort_products()">
                    ...
                    <option value="today,deals" @isset($col_name , $query) @if($col_name == 'today' && $query == 'deals') selected @endif @endisset>{{translate('Today Deals')}}</option>
                    <option value="published,true" @isset($col_name , $query) @if($col_name == 'published' && $query == 'true') selected @endif @endisset>{{translate('Published')}}</option>
                    <option value="featured,true" @isset($col_name , $query) @if($col_name == 'featured' && $query == 'true') selected @endif @endisset>{{translate('Featured')}}</option>
