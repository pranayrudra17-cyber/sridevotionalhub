    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('show_digital_products')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('poojaproducts.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['poojaproducts.index', 'poojaproducts.create', 'poojaproducts.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Pooja') }}</span>
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @if(Auth::user()->email === 'rudra.pranay@gmail.com')
                ...
                <!-- Staffs -->
                @canany(['header_setup','footer_setup','website_appearance'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
